...
public class EntityMoiss5 extends EntityGem {

    public EntityMoiss5(EntityType<? extends CreatureEntity> type, World worldIn) {
        super(type, worldIn);
    }
    ...
    @Override
    public int generateInsigniaColor() { return 12;}
